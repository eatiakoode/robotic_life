...
import { getManufacturerById, updateManufacturerAPI } from "@/api/manufacturer";
...
const CreateList = () => {
  ...
  const [manufacturer, setManufacturer] = useState({ name: "", status: false, description: "" });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // router.push("/cmsthebotsworld/my-manufacturer");
  ...
  return (
    <>
      <form onSubmit={handleSubmit} className="row">
        ...
        <div className="col-lg-6 col-xl-6">
          <div className="my_profile_setting_input form-group">
            <label htmlFor="ManufacturerSlug">Manufacturer Slug</label>
            <input
              type="text"
              className="form-control"
              id="ManufacturerSlug"
        ...
        <div className="col-lg-12">
          <div className="my_profile_setting_textarea form-group">
            ...
            <textarea id="ManufacturerDescription" className="form-control" name="description" rows="7" value={description} onChange={(e) => setDescription(e.target.value)} placeholder="Enter Manufacturer description"></textarea>
        ...
        <div className="col-xl-12">
          <div className="my_profile_setting_input">
            <button className="btn btn1 float-start" type="button" onClick={() => window.location.href = '/cmsthebotsworld/my-manufacturer'}>Back</button>
