...
import { getSliderTableData } from "../../../api/slider";

const index = () => {
  // Use the custom hook for search and pagination
  const {
    currentData: currentSliders,
    loading,
    error,
    searchQuery,
    handleSearch,
    ...
    searchInfo
  } = useSearchAndPagination(getSliderTableData, 10, ['name', 'description', 'status']);
              ...
              <div className="row">
                ...
                <div className="col-lg-4 col-xl-4 mb10">
                  <div className="breadcrumb_content style2 mb30-991">
                    <h2 className="breadcrumb_title">All Sliders</h2>
                    <p>View, search, and manage slider profiles associated with the robot listings.</p>
