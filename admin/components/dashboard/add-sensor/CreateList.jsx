...
const CreateList = () => {
   const [title, setTitle] = useState("");
    ...
    const addSensorAPI = async (e) => {
      ...
      try {
        const data = await addSensorAPI(title); // 🔹 Call the API function
  ...
  return (
    <>
    <form onSubmit={addSensorAPI} className="row">
      <div className="col-lg-6 col-xl-6">
        <div className="my_profile_setting_input form-group">
          <label htmlFor="SensorTitle">Sensor Title</label>
          <input type="text" className="form-control" id="SensorTitle" value={title} onChange={handleTitleChange} />
