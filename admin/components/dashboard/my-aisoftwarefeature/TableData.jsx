...
import { deleteAISoftwareFeatureAPI } from "../../../api/aisoftwarefeature";
  ...
  if (loading) {
    return (
      <div className="text-center py-5">
        ...
        <p className="mt-2">Loading AI/Software features...</p>
      </div>
    );
  }
      ...
      <td className="align-middle text-center">
        <ul className="view_edit_delete_list mb0 d-flex justify-content-center">
          <li className="list-inline-item" title="Edit">
            <button onClick={() => router.push(`/cmsthebotsworld/edit-aisoftwarefeature/${item._id}`)}>
