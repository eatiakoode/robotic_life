...
import { addAutonomyLevelAPI } from "@/api/autonomylevel";
...
const CreateList = () => {
  ...
  const addAutonomyLevel = async (e) => {
    ...
    try {
      const data = await addAutonomyLevelAPI(title);

      toast.success(data.message || "Autonomy Level added successfully!");
  ...
  return (
    <>
      <form onSubmit={addAutonomyLevel} className="row">
        <div className="col-lg-6 col-xl-6">
          <div className="my_profile_setting_input form-group">
            <label htmlFor="autonomyLevelTitle">Autonomy Level Title</label>
            <input type="text" className="form-control" id="autonomyLevelTitle" value={title} onChange={handleTitleChange} />
