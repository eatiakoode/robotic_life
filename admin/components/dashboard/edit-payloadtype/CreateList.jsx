...
const CreateList = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setTimeout(() => {
        router.push("/cmsroboticlife/my-payloadtype");
      }, 1000);
    } catch (error) {
      ...
      <form onSubmit={handleSubmit} className="row">
        ...
        <div className="col-xl-12">
          <div className="my_profile_setting_input">
            <button className="btn btn1 float-start" type="button" onClick={() => window.location.href = '/cmsroboticlife/my-payloadtype'}>Back</button>
