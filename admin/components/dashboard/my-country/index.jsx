...
const index = () => {
  ...
  const {
    ...
    searchInfo
  } = useSearchAndPagination(getCountryTableData, 10, ['title', 'status']);
  return (
    <>
      {/* <!-- Main Header Nav --> */}
      <Header />
              ...
              <div className="row">
                ...
                <div className="col-lg-4 col-xl-4 mb10">
                  <div className="breadcrumb_content style2 mb30-991">
                    <h2 className="breadcrumb_title">Country</h2>
                    <p>View, search, and manage robot countries.</p>
                  ...
                  <div className="my_dashboard_review mb40">
                    <div className="property_table">
                      <div className="table-responsive mt0">
                        <TableData 
                          key={`countries-${currentCountries.length}-${loading}`}
