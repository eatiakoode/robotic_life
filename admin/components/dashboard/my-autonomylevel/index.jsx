...
const index = () => {
  ...
  const {
    ...
    searchInfo
  } = useSearchAndPagination(getAutonomyLevelTableData, 10, ['name', 'description', 'status']);
  return (
    <>
      {/* <!-- Main Header Nav --> */}
      <Header />
              ...
              <div className="row">
                ...
                <div className="col-lg-4 col-xl-4 mb10">
                  <div className="breadcrumb_content style2 mb30-991">
                    <h2 className="breadcrumb_title">Autonomy Level</h2>
                    <p>View, search, and manage autonomy levels for robots.</p>
