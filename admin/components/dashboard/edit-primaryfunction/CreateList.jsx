...
const CreateList = () => {
  ...
  const [primaryFunction, setPrimaryFunction] = useState({ name: "", status: false, description: "" });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // }
      const data = await updatePrimaryFunctionAPI(id, title);
      ...
      alert("Failed to update Primary Function.");
      console.error(error);
    }
  };
