...
const CreateList = () => {
   const [title, setTitle] = useState("");
    ...
    const addPrimaryFunctionAPI = async (e) => {
      ...
      try {
        const data = await addPrimaryFunctionAPI(title); // 🔹 Call the API function
  ...
  return (
    <>
    <form onSubmit={addPrimaryFunctionAPI} className="row">
