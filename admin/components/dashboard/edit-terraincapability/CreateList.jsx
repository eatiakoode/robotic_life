...
const CreateList = () => {
  ...
  const [terrainCapability, setTerrainCapability] = useState({ name: "", status: false, description: "" });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // }
      const data = await updateTerrainCapabilityAPI(id, title);
      ...
      alert("Failed to update Terrain Capability.");
      console.error(error);
    }
  };
      ...
      <form onSubmit={handleSubmit} className="row">
        ...
        <div className="col-xl-12">
          <div className="my_profile_setting_input">
            <button className="btn btn1 float-start" type="button" onClick={() => window.location.href = '/cmswegrow/my-terraincapability'}>Back</button>
