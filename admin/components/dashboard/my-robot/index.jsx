...
const RobotIndex = () => {
  ...
  const {
    ...
    searchInfo
  } = useSearchAndPagination(getRobotTableData, 10, ['name', 'model', 'status', 'manufacturer']);
              ...
              <div className="row">
                ...
                <div className="col-lg-4 col-xl-4 mb10">
                  <div className="breadcrumb_content style2 mb30-991">
                    <h2 className="breadcrumb_title">Robot List</h2>
                    <p>View, search, and manage robots.</p>
