...
import { deleteColorAPI } from "../../../api/color";
import { useState } from "react";
import { useRouter } from "next/navigation";
import { toast } from 'react-toastify';

const TableData = ({ colors = [], loading = false, error = null, onRefresh }) => {
  ...
  let tbodyContent = colors.map((item) => (
      ...
      <td className="align-middle text-center">
        <ul className="view_edit_delete_list mb0 d-flex justify-content-center">
          <li className="list-inline-item" title="Edit">
            <button onClick={() => router.push(`/cmsthebotsworld/edit-color/${item._id}`)}>
