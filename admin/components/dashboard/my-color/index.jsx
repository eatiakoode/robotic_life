...
const index = () => {
  ...
  const {
    ...
    searchInfo
  } = useSearchAndPagination(getColorTableData, 10, ['name', 'status']);
  return (
    <>
      {/* <!-- Main Header Nav --> */}
      <Header />
              ...
              <div className="row">
                ...
                <div className="col-lg-4 col-xl-4 mb10">
                  <div className="breadcrumb_content style2 mb30-991">
                    <h2 className="breadcrumb_title">Color List</h2>
                    <p>View, search, and manage robot color options.</p>
