...
const index = () => {
  ...
  const {
    currentData: currentTerrainCapabilities,
    loading,
    error,
    searchQuery,
    handleSearch,
    ...
    searchInfo
  } = useSearchAndPagination(getTerrainCapabilityTableData, 10, ['name', 'description', 'status']);
  return (
    <>
      {/* <!-- Main Header Nav --> */}
      <Header />
              ...
              <div className="row">
                ...
                <div className="col-lg-4 col-xl-4 mb10">
                  <div className="breadcrumb_content style2 mb30-991">
                    ...
                    <p>View, search, and manage terrain capabilities for robots.</p>
                      ...
                      <li className="list-inline-item">
                        <div className="candidate_revew_search_box course fn-520">
                          <SearchBox 
                            ...
                            placeholder="Search Terrain Capabilities..." 
                          />
                        </div>
                      </li>
                      {/* End li */}
                  ...
                  <div className="my_dashboard_review mb40">
                    <div className="property_table">
                      <div className="table-responsive mt0">
                        <TableData 
                          terrainCapabilities={currentTerrainCapabilities}
                          loading={loading}
                          error={error}
