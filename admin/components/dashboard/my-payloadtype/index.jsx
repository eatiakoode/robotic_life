...
const index = () => {
  ...
  const {
    currentData: currentPayloadTypes,
    loading,
    error,
    searchQuery,
    handleSearch,
    ...
    searchInfo
  } = useSearchAndPagination(getPayloadTypeTableData, 10, ['name', 'description', 'status']);
  return (
    <>
      {/* <!-- Main Header Nav --> */}
      <Header />
              ...
              <div className="row">
                ...
                <div className="col-lg-4 col-xl-4 mb10">
                  <div className="breadcrumb_content style2 mb30-991">
                    <h2 className="breadcrumb_title">Payload Type List</h2>
                    <p>View, search, and manage payload types for robots.</p>
                  ...
                  <div className="my_dashboard_review mb40">
                    <div className="property_table">
                      <div className="table-responsive mt0">
                        <TableData 
                          payloadTypes={currentPayloadTypes}
                          loading={loading}
                          error={error}
